...
TeamMemberProject.create(project_id: 1)
...
# Tasks
Task.create(category: "Frontend", title: "Login", description: "create a login component to allow users to login to the app.", deadline: '2018-08-11', priority: "high", team_member_project_id: 1)
Task.create(category: "Frontend", title: "SignUp", description: "create a component to allow users to register as member for the app.", deadline: '2018-08-11', priority: "high", team_member_project_id: 1)
Task.create(category: "Frontend", title: "Project List", description: "create a component that will render all the different projects to the page.", deadline: '2018-08-11', priority: "high", team_member_project_id: 1)
Task.create(category: "Frontend", title: "Task list", description: "create a component that will render all the different task for a specific project to the page", deadline: '2018-08-11', priority: "high", team_member_project_id: 1)
